		...
		switch (barlayout[i]) {
			...
			case 't':
				...
				for (j = 0; j < LENGTH(tags); j++) {
					...
					drw_text(drw, x, 0, bh, bh, 0, "", urg & 1 << j);
					if (occ & 1 << j)
